...
public partial class Cte
{
    ...
    public string FinalidadeEmissao { get; set; } = null!;

    public string FormaEmissao { get; set; } = null!;

    public string? ChaveAcesso { get; set; }

    public string? ChaveAcessoReferenc { get; set; }

    public string MunicipioEmissao { get; set; } = null!;

    public string MunicipioInicioPrestacao { get; set; } = null!;

    public string MunicipioFimPrestacao { get; set; } = null!;

    public string DadosRetirada { get; set; } = null!;
    ...
    public string TpTomadorServico { get; set; } = null!;

    public int? CdTomadorServico { get; set; }

    public string TpRemetente { get; set; } = null!;

    public int? CdRemetente { get; set; }

    public string TpExpedidor { get; set; } = null!;

    public int? CdExpedidor { get; set; }

    public string TpRecebedor { get; set; } = null!;

    public int? CdRecebedor { get; set; }

    public string TpDestinatario { get; set; } = null!;
    ...
    public string CdStIcms { get; set; } = null!;
    ...
    public string IcmsUfTermino { get; set; } = null!;
    ...
    public string ProdPredominante { get; set; } = null!;
